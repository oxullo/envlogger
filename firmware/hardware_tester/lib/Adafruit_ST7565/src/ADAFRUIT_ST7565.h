...
//  Ported for Particle Devices (tested on Photon) by Veen

Adapted for the display assembly NHD-C12832A1Z-FSW-FBW-3V3 (128x32 FSTN) by OXullo Intersecans <x@brainrapers.org>
...
class ST7565 {
 public:
  ST7565(pin_t SID, pin_t SCLK, pin_t RS, pin_t RST, pin_t CS) : sid(SID), sclk(SCLK), a0(RS), rst(RST), cs(CS) {}
